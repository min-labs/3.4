...
pub fn teardown_all(hub_ip_global: &std::sync::Mutex<String>) {
    eprintln!("[M13-TEARDOWN] Tearing down all tunnel state...");
    ...
    eprintln!("[M13-TEARDOWN] ✓ All tunnel state removed.");
}
