...
pub fn process_client_hello_hub(
    ...
    // V3.5 FIX: Truncate RLNC parity trailing zeroes from ClientHello reassembly
    hasher.update(&reassembled[0..EXPECTED_LEN]);
    ...
    Some((HubHandshakeState {
        ...
        session_nonce,
        // V3.5 FIX: Truncate RLNC parity trailing zeroes
        client_hello_bytes: reassembled[0..EXPECTED_LEN].to_vec(),
